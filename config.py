...
PASTE_ENTER_DELAY_S = 0.3
WAITING_BAR_TIMEOUT_S = 10
FOREGROUND_DELAY_S = 0.15
ACTIVATION_POST_DELAY_S = 0.4
QW_RELEASE_DELAY_S = 0.3
COPY_CLIPBOARD_DELAY_S = 0.3
...
# === 对话框截图监控参数 ===
DIALOG_SCREENSHOT_INTERVAL_S = 10
DIALOG_SCREENSHOT_KEEP_COUNT = 2

# === AI输出监控参数 ===
OUTPUT_MONITOR_CHECK_INTERVAL_S = 60
OUTPUT_MONITOR_CAPTURE_GAP_S = 10
OUTPUT_MONITOR_CONSECUTIVE_STOPS = 2
OUTPUT_MONITOR_PIXEL_DIFF_THRESHOLD = 5.0
OUTPUT_MONITOR_MAX_DURATION_S = 1200
